...
class ConstrainedPWCalculation(PwCalculation):
    ...
    def write_oscdft_data(self, parameters: TypedDict[str, Any], occupation_numbers) -> str:
        """
        ...
        Args:
            ...
            occupation_numbers: A list of 3D numpy array with the occupation numbers.
        ...
        natoms = len(occupation_numbers)
        nspin = 2
        # simpler version of the loop
        for iatom in range(natoms):
            for ispin in range(nspin):
                occupation_numbers_iatom = occupation_numbers[iatom][ispin]
                for iorb_tuple in np.ndindex(occupation_numbers_iatom.shape):
                    value = occupation_numbers_iatom[iorb_tuple]
                    
                    # Convert 0-based Python indices back to 1-based for the output file
                    idx1 = iatom + 1 
                    idx2 = ispin + 1
                    idx3, idx4 = (i + 1 for i in iorb_tuple)
